...
import com.votingresult.Adapters.KingAdapter;
...
public class KingActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_king, container, false);
        king_recycler = (RecyclerView) v.findViewById(R.id.king_recycler);
        king_recycler.setLayoutManager(new LinearLayoutManager(getContext()));
        king_adapter = new KingAdapter(getContext(), name, age,height,natives,favourite_color,hobbies,idol_person,fb_account,profile);
